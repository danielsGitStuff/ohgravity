...
public class OObject implements OMesh {
    ...
    public synchronized void mergeWith(OObject toMergeWith) {
        if (this.toBeMergedWith == null) {
            if (this.thingsToMerge == null)
                this.thingsToMerge = new ArrayList<>();
     ...
     * @param y
     * @param z
     * @param scopeRadius radius in which other oobjects are influenced
     */
    ...
    private void calculateProperties() {
        ...
        float[] colors = new float[]{r, g, b, r, g, b, r, g, b, r, g, b, r, g, b, r, g, b, r, g, b, r, g, b, r, g, b, r, g,
    ...
    public void calculatePhysics() {
        ...
        if (this.thingsToMerge != null) {
            ...
            for (OObject toMergeWith : this.thingsToMerge) {
    ...
    public static void init() {
        ...
        ByteBuffer bbGlobalAmbient = ByteBuffer.allocateDirect(global_ambient.length * 4).order((ByteOrder.nativeOrder()));
        ...
        FloatBuffer ambientBuffer = bbGlobalAmbient.asFloatBuffer();
    ...
    public void draw(GL2 gl) {
        float sizeMulti = (float) (Math.sqrt(getCollisionRadiusSquared()));
        gl.glPushMatrix();
